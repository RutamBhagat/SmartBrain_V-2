        ...
        return (
            <header class="text-gray-600 body-font custom-bg">
                <div class="container-fluid mx-10 flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <button onClick={ () => onRouteChange("signin") } class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Sign Out
